...
NeuralNetwork::NeuralNetwork(unsigned int numInput, unsigned int numHidden, unsigned int numOutput,
...
unsigned int NeuralNetwork::getNumInput(){
    return numInput;
}

unsigned int NeuralNetwork::getNumHidden(){
    return numHidden;
}

unsigned int NeuralNetwork::getNumOutput(){
    return numOutput;
}
